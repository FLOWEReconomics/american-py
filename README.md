1 "Small Py Big Fight, Big Py No Fight" ~ #earthen: Liberty Egalite Actualites Fraternity Sexualite [LEAFS] 
2 "Get attacked, relieve ally" ~ #MerciBeaucoup: differentiated Anthropomorphic Binary Computation [dABC] 
3 "CIA.5 = CIA_2 + CIA⚡8" ~ #EasyA: SYNTHESIS = thesis + Antithesis [Avatar]
4 "When a Warrior falls off her horse, even the accountant renders advice on how to ride " ~ #Irrationality: universal Nash Equilibrium Strategy [uNESt] 
5 "What if the light at the end of the tunnel is a train" ~ #Burn: .... [DESTRUCTA X]
6 "Belief in death is a self-fulfilling prophecy" ~ #Prerogative: ..... [COUNTERSTRIKE]
7 
